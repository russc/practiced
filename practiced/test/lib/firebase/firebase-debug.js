   ...
   while(parentTree !== null) {
      ...
      if(parentQueryMap !== null) {
         if(parentQueryMap.hasDefaultQuery()) {
            ...
            var viewState = fb.util.obj.get(childRelevance, childTree.key());
   ...
   if(queryMap !== null) {
      ...
      subTree.forEachChild(function(childTree) {
         if(node.isLeafNode()) {
            ...
            childNode = node.getImmediateChild(childTree.key())
         }
...
Firebase.prototype.onDisconnect = function() {
   return new fb.api.onDisconnect(this.repo, this.path, this.key())
};
